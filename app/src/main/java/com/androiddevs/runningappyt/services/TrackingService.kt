...
import com.androiddevs.runningappyt.other.Constants.NOTIFIACTION_ID
import com.androiddevs.runningappyt.other.Constants.NOTIFICATION_CHANNEL_ID
import com.androiddevs.runningappyt.other.Constants.NOTIFICATON_CHANNEL_NAME
...
class TrackingService : LifecycleService() {
    ...
    private fun startForegroundService() {
        ...
        startForeground(NOTIFIACTION_ID, baseNotificationBuilder.build())
    ...
    private fun updateNotificationTrackingState(isTracking: Boolean)
    {
        ...
        notificationManager.notify(NOTIFIACTION_ID,currentNotificationBuilder.build())}
    }
